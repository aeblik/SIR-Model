...
# Model Formulation
We consider a spatially distributed population in 2D over time. 
...
The PDE System used, represent spatial movement solely for the infected compartment through the diffusion rate $D_I \ge 0$.
...
$$
\begin{align}
\frac{\partial S}{\partial t} &= -\beta \frac{S I}{N}, \tag{1}\\
\frac{\partial I}{\partial t} &= D_i \nabla^2 I + \beta \frac{S I}{N} - \gamma I, \tag{2}\\
\frac{\partial R}{\partial t} &= \gamma I. \tag{3}
\end{align}
$$

where the infection term $\beta \frac{SI}{N}$ transfers individuals from $S$ to $I$, and the recovery term $\gamma I$ transfers individuals from $I$ to $R$. The diffusion term in $I$ models random movement of infectious individuals in space, which leads to the spatial spread of the disease.
